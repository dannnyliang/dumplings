...
- [x] 7.1 分類支出改為與前三月平均的差異呈現
- [x] 7.2 評估移除 Recharts（確認無其他使用後從 dependencies 移除）

## 8. 導覽

- [x] 8.1 `BottomNav` 從 5 格縮為 3 格（首頁／報表／FAB）
- [x] 8.2 新增設定頁，收納分類、定期、共同卡設定
- [x] 8.3 更新 `navDirection` 的頁面順序契約
